...
create table deuda (id bigint not null auto_increment, fecha_ultima_actualizacion datetime(6), monto float not null, monto_maximo float not null, domicilio_id bigint, primary key (id)) engine=InnoDB;
create table deuda_pago (id bigint not null auto_increment, monto_adeudado_pago float not null, deuda_id bigint, pago_id bigint, primary key (id)) engine=InnoDB;
...
create table pago (id bigint not null auto_increment, fecha_pago datetime(6), total float not null, entrega_id bigint, estado_pago_id bigint, medio_pago_id bigint, primary key (id)) engine=InnoDB;
