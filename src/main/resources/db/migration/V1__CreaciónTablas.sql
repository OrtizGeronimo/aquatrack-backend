...
create table domicilio (id bigint not null auto_increment, calle varchar(255), numero integer, piso_departamento varchar(255), observaciones varchar(255), fecha_fin_vigencia datetime(6), cliente_id bigint, deuda_id bigint, ubicacion_id bigint, primary key (id)) engine=InnoDB;
