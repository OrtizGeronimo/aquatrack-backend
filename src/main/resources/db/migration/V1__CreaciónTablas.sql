...
create table entrega (id bigint not null auto_increment, fecha_hora_visita datetime(6), observaciones varchar(255), orden_visita  integer, domicilio_id bigint, estado_entrega_id bigint, pago_id bigint, reparto_id bigint, monto decimal(10,2), primary key (id)) engine=InnoDB;
