...
INSERT INTO rol (id,activo,fecha_creacion,fecha_fin_vigencia,nombre,empresa_id)
VALUES (1,1,CURRENT_DATE,NULL,'ROLE_ADMIN',1),
       (2,1,CURRENT_DATE,NULL,'ROLE_CLIENTE',1),
       (3,1,CURRENT_DATE,NULL,'ROLE_REPARTIDOR',1),
       (4,1,CURRENT_DATE,NULL,'ROLE_OFICINISTA',1),
       (5,1,CURRENT_DATE,NULL,'ROLE_ADMIN',2),
       (6,1,CURRENT_DATE,NULL,'ROLE_CLIENTE',2),
       (7,1,CURRENT_DATE,NULL,'ROLE_REPARTIDOR',2),
       (8,1,CURRENT_DATE,NULL,'ROLE_ADMIN',3),
       (9,1,CURRENT_DATE,NULL,'ROLE_CLIENTE',3),
       (10,1,CURRENT_DATE,NULL,'ROLE_REPARTIDOR',3),
       (11,1,CURRENT_DATE,NULL,'ROLE_ADMIN',4),
       (12,1,CURRENT_DATE,NULL,'ROLE_CLIENTE',4),
       (13,1,CURRENT_DATE,NULL,'ROLE_REPARTIDOR',4),
       (14,1,CURRENT_DATE,NULL,'ROLE_OFICINISTA',2),
       (15,1,CURRENT_DATE,NULL,'ROLE_OFICINISTA',3),
       (16,1,CURRENT_DATE,NULL,'ROLE_OFICINISTA',4);
